...
public class MethodUtils {
	...
	public static Map<Character, String> incomeTypes() {
		Map<Character, String> incomeTypes = new HashMap<Character, String>();
		incomeTypes.put('R', "Revenue");
		incomeTypes.put('E', "Expenditure");
		return incomeTypes;
	}
